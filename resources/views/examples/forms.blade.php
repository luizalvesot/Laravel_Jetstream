																																					...
																																					<div class="card-body">
																																						<form action="" method="post">
																																							<div class="form-group">
																																								...
																																								<input class="form-control" id="nf-email" type="email" name="nf-email" placeholder="Enter Email.." autocomplete="email">
																																									<span class="help-block">Please enter your email</span>
																																								</div>
																																								<div class="form-group">
																																									<label for="nf-password">Password</label>
																																									<input class="form-control" id="nf-password" type="password" name="nf-password" placeholder="Enter Password.." autocomplete="current-password">
																																										<span class="help-block">Please enter your password</span>
																																									</div>
																																								</form>
																																							</div>
																																																																																															...
																																																																																															<form class="form-horizontal">
																																																																																																<div class="form-group">
																																																																																																	...
																																																																																																	<div class="form-group">
																																																																																																		...
																																																																																																		<div class="controls">
																																																																																																			<div class="input-group">
																																																																																																				<input class="form-control" id="appendedInput" size="16" type="text">undefined<div class="input-group-append">undefined<span class="input-group-text">.00</span>undefined</div>
																																																																																																				</div>
																																																																																																		...
																																																																																																		<div class="form-group">
																																																																																																			...
																																																																																																			<div class="controls">
																																																																																																				<div class="input-prepend input-group">undefined<div class="input-group-prepend">undefined<span class="input-group-text">$</span>undefined</div>undefined<input class="form-control" id="appendedPrependedInput" size="16" type="text">undefined<div class="input-group-append">undefined<span class="input-group-text">.00</span>undefined</div>undefined</div>
																																																																																																				</div>
																																																																																																			</div>
																																																																																																			<div class="form-group">
																																																																																																				<label class="col-form-label" for="appendedInputButton">Append with button</label>
																																																																																																				<div class="controls">undefined<div class="input-group">undefined<input class="form-control" id="appendedInputButton" size="16" type="text">undefined<span class="input-group-append">undefined<button class="btn btn-secondary" type="button">Go!</button>undefined</span>undefined</div>undefined</div>
																																																																																																				</div>
																																																																																																				<div class="form-group">undefined<label class="col-form-label" for="appendedInputButtons">Two-button append</label>undefined<div class="controls">undefined<div class="input-group">undefined<input class="form-control" id="appendedInputButtons" size="16" type="text">undefined<span class="input-group-append">undefined<button class="btn btn-secondary" type="button">Search</button>undefined<button class="btn btn-secondary" type="button">Options</button>undefined</span>undefined</div>undefined</div>undefined</div>undefined<div class="form-actions">undefined<button class="btn btn-primary" type="submit">Save changes</button>undefined<button class="btn btn-secondary" type="button">Cancel</button>undefined</div>
																																																																																																				</form>
																																																																																																			</div>
																																																																																																		</div>
																																																																																																	</div>
